    ...
    export class RoomData extends pb_1.Message {
        ...
        constructor(
            ...
            if (!Array.isArray(data) && typeof data == "object") {
                ...
                if (
                    "room_capacity" in data &&
                    data.room_capacity != undefined
                ) {
        ...
        static fromObject(data: {
            members?: ReturnType<
                typeof RoomData.RoomMember.prototype.toObject
            >[];
            field_2?: number;
            field_3?: number;
            field_4?: number;
            ...
            if (data.members != null) {
                message.members = data.members.map((item) =>
                    RoomData.RoomMember.fromObject(item)
                );
            }
        ...
        toObject() {
            ...
            if (this.members != null) {
                data.members = this.members.map((item: RoomData.RoomMember) =>
                    item.toObject()
                );
            }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.members.length)
                writer.writeRepeatedMessage(
                    1,
                    this.members,
                    (item: RoomData.RoomMember) => item.serialize(writer)
                );
                    ...
                    case 1:
                        reader.readMessage(message.members, () =>
                            pb_1.Message.addToRepeatedWrapperField(
                                message,
                                1,
                                RoomData.RoomMember.deserialize(reader),
                                RoomData.RoomMember
                            )
                        );
                        break;
